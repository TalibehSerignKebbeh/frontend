...
import {
    DataGrid, gridClasses, GridToolbar,
...
const SalesTablePage = ({ sales, page, setpage, pageSize, setpageSize, rowCount, loading }) => {
    ...
    const columns = useMemo(() => [
        ...
        {
            field: 'saleDate', type: 'dateTime', headerName: 'Date', width: 170,
            valueGetter: ({ value }) => value && format(parseISO(value), 'do MMM yyyy HH:mm')
        },
    ...
    return (
        ...
        >
            ...
            <DataGrid
                rowCount={rowCount}
                rows={sales?.length? sales : []} checkboxSelection
                ...
                sx={{
                    ...
                    [`& .${gridClasses.columnHeader}`]: {
                        fontSize: '1rem', bgcolor: '#25ba66', color: 'white'
                    },
